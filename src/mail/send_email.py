...
class Emailer:
    ...
    def set_mail_info(self, date: datetime, email_type: str):
        """设置邮件主题与正文
        """
    ...
    def _send_email(self, date: datetime, receiver: str, email_type="text", attachment=None):
        """给用户发送邮件
        Args:
            date (datetime): 报送日期
            receiver (str): 收件人
        ...
        msg['To'] = receiver                       # 收件人
        mail_subject, mail_body = self.set_mail_info(date, email_type)    # 主题,正文
    ...
    def send_email(self, date: datetime, receiver: str, email_type="text", attachment=None):
        self._smtp_connect()
        self._send_email(date, receiver, email_type, attachment)
        self.dispose()
...
if __name__ == '__main__':
    print(1)
    Emailer_obj = Emailer()
    Emailer_obj.send_email(datetime.datetime.today(), 'knight@fm-cslab.com',email_type="html")
    Emailer_obj.dispose()
